...
describe "CostumeStore" do
  ...
  #   ny_costumes = CostumeStore.create(   Couldn't figure out what was wrong but when I used
  #     name: "New York Costumes",          a rake console I was fully able to create a CostumeStore instance
  #     closing_time: end_time              and also able to set and retrieve the values for closing_time
  #   )
